...
public class _MappingKit {
	...
	public static void mapping(ActiveRecordPlugin arp) {
		...
		arp.addMapping("sys_userinfo", "ids", SysUserinfo.class);
		arp.addMapping("sys_userrole", "id", SysUserrole.class);
		arp.addMapping("t_product", "id", Product.class);
		arp.addMapping("t_product_version", "id", ProductVersion.class);
	}
}
